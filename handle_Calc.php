...
/* This script takes values from calclator.html and performs total cost and monthly payment calculations. */
...
print "<p>You have selescted to purchase:<br>
...
After you $<span class=\"number\">$discount</span> discount, the total cost is
